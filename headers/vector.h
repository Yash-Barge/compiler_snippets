...
struct vector_tree_node_lib {
    struct vector_string *(*const new)(void);
    int (*const size)(struct vector_string *);
    void (*const insert)(struct vector_string *, int, void*);
    void*(*const erase)(struct vector_string *, int);
    void (*const push_back)(struct vector_string *, void*);
    void*(*const pop_back)(struct vector_string *);
    void (*const push_front)(struct vector_string *, void*);
    void*(*const pop_front)(struct vector_string *);
    const void*(*const at)(struct vector_string *, int);
    void (*const print)(struct vector_string *);
    void (*const free)(struct vector_string **);
};
...
extern const struct vector_tree_node_lib VectorNodes;
