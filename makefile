...
prog: main.o stack.o vector.o queue.o hashmap.o errors.o
	...
	rm -f *.o
	./prog
test: main.o stack.o vector.o queue.o hashmap.o errors.o
	$(CC) $(CFLAGS) -o prog main.o stack.o vector.o queue.o hashmap.o errors.o
	rm -f *.o
	./prog -Tall
main.o: main.c data_structs/stack.h data_structs/vector.h data_structs/queue.h data_structs/hashmap.h
	$(CC) $(CFLAGS) -c main.c
